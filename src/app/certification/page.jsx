...
const page = () => {
  return (
    <>
      <h1 className='text-4xl md:text-7xl text-center md:text-start p-[100px_8%]'><span className='text-gray-400'>СЕРТИФИКАТЫ</span> <br />
        <strong>КОМПАНИИ</strong>
      </h1>

      <section className='flex flex-col md:flex-row w-[85%] m-auto justify-between items-center'>
      ...
      <div className='flex w-[85%] m-auto justify-center md:justify-end items-center'>
        <p className='text-3xl md:text-5xl p-[100px_8%]'><strong>01</strong>  <span className='text-gray-400'>/  05</span> </p>
